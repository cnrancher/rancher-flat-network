...
func (v *version) ReplicaSet() ReplicaSetController {
	return generic.NewController[*v1.ReplicaSet, *v1.ReplicaSetList](schema.GroupVersionKind{Group: "apps", Version: "v1", Kind: "ReplicaSet"}, "replicasets", true, v.controllerFactory)
}
