	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.FlatnetworkV1().Subnets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FlatnetworkV1().Subnets(namespace).Watch(context.TODO(), options)
			},
		},
		&flatnetworkcattleiov1.Subnet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *subnetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&flatnetworkcattleiov1.Subnet{}, f.defaultInformer)
}
